INDIC_NLP_LIB_HOME = "/path to the/indic_nlp_library"
INDIC_NLP_RESOURCES = "/path to the /indic_nlp_resources"
import sys
...
if __name__ == "__main__":
    infname = "/path to the test reference file/devtest/all/mai_Deva-hin_Deva/test.hin_Deva" #sys.argv[1]
    outfname = "/path to the test reference file/devtest/all/mai_Deva-hin_Deva/test.hin_Deva.tok"     #sys.argv[2]
    lang = "en"
    transliterate = "False"
    remove_tag = "True"
